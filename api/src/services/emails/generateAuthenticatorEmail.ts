...
const generateAuthenticatorEmail = (url: string, farewell: string, noreply: string, address: string, phone: string, person_name: string, code: string) =>
  `<!doctype html>
<html>
            ...
            <td style="margin: 0;padding: 0;" width="92%" valign="top" align="left">
              <table style="width:100%;font-size:16px; line-height:
                ...
                <tbody>
                  ...
                  <tr>
                    <td style="padding-top: 30px;">
                      Código de autorização de acesso<br>
                      Código de autorización de acceso<br>
                      Access authorization code<br>
                      Code d'autorisation d'accès <br>
                    </td>
                  </tr>
                  <tr>
                  <td align="center" valign="center" style="text-align: center;">
                    <table class="code-container" style="width: 100%;
                    ...
                    padding-top: 25px;">
                        <tbody align="center">
                            <tr >
                              <td width="25%"></td>
                              <td>
                                <td style="background: #00b3e6;font-size: 2rem;border-radius: 5px;font-family: Arial,sans-serif,'Motiva Sans';padding: 10px;color:white;user-select: text;">${code}</td>
                              </td>
                              <td width="25%"></td>
                            </tr>
                        </tbody>
...
export default generateAuthenticatorEmail
