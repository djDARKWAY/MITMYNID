...
const generateDeleteEmail = (url: string, farewell: string, noreply: string, address: string, phone: string, person_name: string, code: string) =>
  `<!doctype html>
<html>
            ...
            <td style="margin: 0;padding: 0;" width="92%" valign="top" align="left">
              <table style="width:100%;font-size:16px; line-height:
                ...
                <tbody>
                  ...
                  <tr>
                    <td style="padding-top: 30px;">
                      Quer <b>eliminar</b> a sua conta? A sua informação será apagada!<br>
                      ¿Quiere <b>eliminar</b> su cuenta? ¡Su información será eliminada!<br>
                      Do you want to <b>delete</b> your account? Your information will be deleted!<br>
                      Voulez-vous <b>supprimer</b> votre compte? Vos informations seront supprimées!<br>
                      <br>
                      <a href="${url}/#/deleteAccount?request=${code}">Sim / Si / Yes / Oui</a>
                    </td>
                  </tr>
                </tbody>
              </table>
...
export default generateDeleteEmail
