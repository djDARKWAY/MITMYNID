...
const generateForgotPassEmail = (url: string, farewell: string, noreply: string, address: string, phone: string, person_name: string, code: string) =>
  `<!doctype html>
<html>
...
export default generateForgotPassEmail
