...
const generateRegisterEmail = (url: string, farewell: string, noreply: string, address: string, phone: string, person_name: string, code: string) =>
  `<!doctype html>
<html>
            ...
            <td style="margin: 0;padding: 0;" width="92%" valign="top" align="left">
              <table style="width:100%;font-size:16px; line-height:
                ...
                <tbody>
                  ...
                  <tr>
                    <td style="padding-top: 30px;">
                      Para concluir o registo de utilizador, clique <a href="${url}/#/validateReg?request=${code}">aqui</a>.<br>
                      Para completar el registro de usuario, haga clic <a href="${url}/#/validateReg?request=${code}">aquí</a>.<br>
                      To complete user registration, click <a href="${url}/#/validateReg?request=${code}">here</a>.<br>
                      Pour terminer l’enregistrement de l’utilisateur, cliquez <a href="${url}/#/validateReg?request=${code}">ici</a>.<br>
                    </td>
                  </tr>
                </tbody>
              </table>
...
export default generateRegisterEmail
